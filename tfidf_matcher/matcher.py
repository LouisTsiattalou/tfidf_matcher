...
"""Takes two lists, returns top `n` matches from `lookup` dataset.
...
:param n_matches: Maximum length of the n-gram. Defaults to 3.
:type n_matches: int
...
...
# TODO Assertions
def matcher(original = [], lookup = [], n_matches = 5):
